    ...
    <div className="w-full max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <div className="text-sm text-yellow-700 space-y-1">
          <p>• Accepted payment methods: Visa, Mastercard, PayPal, Bitcoin, and 200+ other methods</p>
          <p>• Secure payment processing via Payeer</p>
          <p>• Global payment system with support for African countries</p>
